...
import 'Game3Strage2Screen3.dart';
class Game3Screen2Stage2HA extends StatefulWidget {
   String docidb;

  Game3Screen2Stage2HA({Key? key, required this.docidb}) : super(key: key);

  @override
  _Game3Screen2Stage2HAState createState() => _Game3Screen2Stage2HAState(
    docidb: this.docidb,
  );
}

class _Game3Screen2Stage2HAState extends State<Game3Screen2Stage2HA> with TickerProviderStateMixin {
  final String docidb;
  _Game3Screen2Stage2HAState({required this.docidb});
                  ...
                  child: GestureDetector(
                    onTap: (){
                      ...
                      CoolAlert.show(
                          ...
                          onConfirmBtnTap: ()=>Navigator.pushReplacementNamed(context, 'Game3Stage2Screen2'),
                          loopAnimation: true,
                        ...
                        setState(() {
                          ...
                          if(nextscreen==4){
                            Future.delayed(const Duration(seconds: 1), () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) =>  Game3Stage2Screen3(docidb: docidb,)),
                              );
                            });
                          }
                        });
