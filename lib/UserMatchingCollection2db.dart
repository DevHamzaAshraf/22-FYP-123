...
class UserMatchingCollection2DB extends StatelessWidget {
  final db = FirebaseFirestore.instance;
  final String Userid;
  UserMatchingCollection2DB({Key? key, required this.Userid}) : super(key: key);
  @override
          ...
          body: Container(
            ...
            child: StreamBuilder(
              ...
              stream: FirebaseFirestore.instance
                  .collection('MatchingCollection2').where("Name", isEqualTo: "$Userid").snapshots(),
