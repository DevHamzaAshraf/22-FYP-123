...
class UserMatchingGameDB extends StatelessWidget {
  final db = FirebaseFirestore.instance;
  final String Userid;
  UserMatchingGameDB({Key? key, required this.Userid}) : super(key: key);
  @override
          ...
          body: Container(
            ...
            child: StreamBuilder(
              ...
              stream: FirebaseFirestore.instance
                  .collection('MatchingCollection').where("Name", isEqualTo: "$Userid").snapshots(),
