...
class UserTappingBoardDB extends StatelessWidget {
  final db = FirebaseFirestore.instance;
  final String Userid;
  var FirebaseUser =  FirebaseAuth.instance.currentUser;
  UserTappingBoardDB({Key? key, required this.Userid}) : super(key: key);
  @override
          ...
          body: Container(
            ...
            child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  .collection('TappingBoard').where("Name", isEqualTo: "$Userid").snapshots(),
